...
namespace MCServerSharp
{
    public static class MarvinHash64
    {
        ...
        public static int CollapseHash32((uint p0, uint p1) hash)
        {
            return (int)(hash.p1 ^ hash.p0);
        }

        public static long CollapseHash64((uint p0, uint p1) hash)
        {
            return (long)((ulong)hash.p1 << 32 | hash.p0);
        }
        ...
        public static (uint p0, uint p1) ComputeHash(ReadOnlySpan<byte> data, ulong seed)
        {
            return ComputeHash(
        ...
        public static (uint p0, uint p1) ComputeHash(ref byte data, uint count, uint p0, uint p1)
        {
            ...
            uint partialResult = Unsafe.ReadUnaligned<uint>(
                ref Unsafe.Add(ref Unsafe.Add(ref data, (int)(count & 7)), -4));
